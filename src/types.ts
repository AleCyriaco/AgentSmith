...
export type Machine = {rustdeskWebUrl?:string;id:string; name:string; protocol:'rdp'|'rustdesk'|'nanokvm'|'nanokvm_pro'|'nanokvm_usb'; host:string; port:number; username:string; domain:string; fingerprint:string;display?:DisplaySettings};
