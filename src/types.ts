...
export type Settings = {profiles:Profile[]; machines:Machine[]; routes:{planner:string[];operator:string[];verifier:string[];vision?:string[]}; localOnly:boolean; maxActions:number;performance?:PerformanceSettings};
